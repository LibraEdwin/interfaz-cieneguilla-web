...
export default function Paquete({ listaEstados, listaZonas, listaCampañas }) {
    ...
    shouldLogin
      ...
      : <>
        <PaqueteTuristicoProvider>
          <HeaderAdmin title="Paquete Turístico" />

          <ContentPaquete listaEstados={listaEstados} listaZonas={listaZonas} listaCampañas={listaCampañas} />
...
export async function getServerSideProps({ params }) {
  ...
  const dataCampañas = await getData(`${process.env.URI_API}/api-cieneguilla-service/campania`)
  const listaCampañas = dataCampañas.map(campaña => { return { id: campaña._id, texto: campaña.nombreCampaña } })
